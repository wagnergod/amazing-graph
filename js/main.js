// Script main.js por | by Wagner Godinho Atualizado em | Update: 25/04/2021 


let i = 0; // Declara a variável 'i' e lhe atribui um valor | Declare the variable 'i' and assign a value 

/* Cria uma função chamada toggleMenu, que ao ser chamada, dependendo do valor da variável 'i'
	exibirá ou esconderá os itens do mobile menu. Funcionará como um interruptor. */

/* Create a function toggleMenu, when called, depending the value of variable 'i', it will show
